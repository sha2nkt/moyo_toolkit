...
import smplx
from lib.utils.geometry import matrix_to_axis_angle, ea2rm, axis_angle_to_matrix
from utils.constants import frame_select_dict_combined as frame_select_dict
from utils.constants import YOGA82_PATH
from biomech_eval_utils import BiomechanicalEvaluator
from pressure_mat_utils import PressureMat
...
def yoga82_extra(img_folder, pp_folder, pressure_xml_folder, pressure_csv_folder, model_folder,
    ...
    for i, pname in enumerate(tqdm(all_pose_names)):
        ...
        pressure_mat_c3d = pressure_xml.replace('pressure', 'vicon').replace('/xml/', '/3_Gaps_filled/').replace('.xml', '.c3d')
        ...
        for cam in range(1, 4):
            ...
            for img_path in images[
                ...
                if cam == 1:
                    ...
                    cv2.imwrite(os.path.join(out_pressure_heatmap_dir, f'{pname}_{pressure_fnum}_gt.png'),
                                heatmap_large)
                    print('[[GT Pressure Heatmap Saved]]\n',
                          os.path.join(out_pressure_heatmap_dir, f'{pname}_{pressure_fnum}_gt.png'))
...
if __name__ == "__main__":
    ...
    yoga82_extra(args.img_folder, args.pp_folder, args.pressure_xml_folder, args.pressure_csv_folder, args.model_folder)