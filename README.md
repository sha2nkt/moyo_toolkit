...
```
cd existing_repo
git remote add origin https://gitlab.is.tue.mpg.de/stripathi/moyo.git
git branch -M master
...
- [ ] [Set up project integrations](https://gitlab.is.tue.mpg.de/stripathi/moyo/-/settings/integrations)
